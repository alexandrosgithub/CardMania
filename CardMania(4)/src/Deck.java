...
public class Deck {
	...
	public Deck(){
		/*Η κλάση αυτή είναι κοινή και για τα τρία παιχνίδια. Δημιουργεί αντικείμενα της κλάσσης Card που αντιστοιχούν 
		 * στα χαρτιά της τράπουλας και τα προσθέτει στο ArrayList deck που στην ουσία είναι η τράπουλα. Περίεχει
		 * μεθόδους που αντιστοιχούν σε ενέργεις όπως το τράβηγμα χαρτιού και ανακάτεμα της τράπουλας.
		 */
		Card AceOfSpades = new Card(1, 1);
		Card AceOfHearts = new Card(1, 2);
		Card AceOfDiamonds = new Card(1, 3);
		Card AceOfClubs = new Card(1, 4);
	...
	public void NewDeck(){
		 ...
		 * 11 είναι ο βαλές, 12 η ντάμα 13 ο παππάς 1 ο άσσος.
