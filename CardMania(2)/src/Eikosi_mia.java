...
public class Eikosi_mia{
	...
	public void amateur_computer_pick(){
		...
		if((computer_cards.get(0).getNumber()==14||computer_cards.get(1).getNumber()==14)&&((computer_cards.get(0).getNumber()==11||computer_cards.get(0).getNumber()==12||computer_cards.get(0).getNumber()==13)||(computer_cards.get(1).getNumber()==11||computer_cards.get(1).getNumber()==12||computer_cards.get(1).getNumber()==13)))
